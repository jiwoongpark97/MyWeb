    ...
    return (
        <NavbarBs className='w-100' style={{ backgroundColor: 'transparent', position: 'fixed', top: 0, pointerEvents: 'none', userSelect: 'none', height: '150px', zIndex: 2 }}>
            <Container className='d-flex justify-content-between'>
                ...
                <Button style={{ width: '3rem', height: '3rem', position: 'relative', pointerEvents: 'auto', zIndex: 2, borderColor: 'black' }} variant='outline-primary' className='rounded-circle' onClick={openCart}>
                    <svg
